...
# This script uses some Phishing Pages generated by SocialFish tool (UndeadSec) (https://github.com/Shymon-Hasan)
# Instagram Phishing Page generated by An0nUD4Y (https://github.com/Shymon-Hasan) 
